	...
	<xsl:template match="/">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:bookmark-tree>
				...
				<xsl:if test="$show-cover-page = 1">
					<fo:bookmark internal-destination="cover-page">
						<fo:bookmark-title><xsl:value-of select="$msg/*/entry[@key='Cover_Page']"/></fo:bookmark-title>
					</fo:bookmark>
				</xsl:if>
				<xsl:if test="$show-metadata-info = 1">
					<fo:bookmark internal-destination="metadata-info">
						<fo:bookmark-title><xsl:value-of select="$msg/*/entry[@key='Document_Information']"/></fo:bookmark-title>
					</fo:bookmark>
				</xsl:if>
				-->
			...
			<!-- Var groups bookmarks -->
				...
				<!-- Alphabetical variables list bookmarks if separate
				<xsl:if test="$show-variables-list = 1">
					<fo:bookmark internal-destination="variables-list_alpha">
						<fo:bookmark-title><xsl:value-of select="$msg/*/entry[@key='Alpha_Varlist']"/></fo:bookmark-title>
					</fo:bookmark>
						...
						<fo:block margin-left="0cm" margin-right="0.5in">
							...
							<xsl:if test="$show-files-description = 1">
								...
								<fo:block font-size="10pt" text-align-last="justify">
									...
									<xsl:for-each select="/ddi:codeBook/ddi:dataDscr/ddi:varGrp">
										<xsl:if test="contains($subsetGroups,concat(',',@ID,',')) or string-length($subsetGroups)=1">
											<fo:block margin-left="0.7in" font-size="18pt"
							...
							end of Original server version-->
							...
							<!--Alphabetical list if separate entry
							<xsl:if test="$show-variables-list = 1">
								<fo:block space-before="0.5cm" font-size="12pt" text-align-last="justify">
									<fo:basic-link internal-destination="variables-list" text-decoration="none" color="{$forsblue}">
										<xsl:value-of select="$msg/*/entry[@key='Alpha_Varlist']"/><fo:leader leader-pattern="dots"/><fo:page-number-citation ref-id="variables-list_alpha"/>
...
<!--										--><!-- report/analytrical --><!--
										<xsl:if test="$rep-count >0 or $anl-count > 0">
											<fo:block margin-left="0.7in" font-size="12pt" text-align-last="justify">
												<fo:basic-link internal-destination="documentation-anl" color="{$forsblue}">
													...
													<fo:leader leader-pattern="dots"/><fo:page-number-citation ref-id="documentation-anl"/>
												</fo:basic-link>
											</fo:block>
										</xsl:if>
										--><!-- questionnaires --><!--
										...
										<fo:block margin-left="0.7in" font-size="12pt" text-align-last="justify">
											...
											<fo:leader leader-pattern="dots"/><fo:page-number-citation ref-id="documentation-unc"/>
										</fo:basic-link>
										</fo:block>
						...
						<fo:table table-layout="fixed" width="100%">
							...
							<fo:table-body>
								...
								<xsl:if test="$show-producers-and-sponsors = 1">
									<fo:table-row background-color="{$color-gray1}" keep-with-next="always">
										<fo:table-cell number-columns-spanned="2" border="{$default-border}" padding="{$cell-padding}">
											<fo:block id="producers-and-sponsors" font-size="12pt" font-weight="normal"><xsl:value-of select="$msg/*/entry[@key='Producers_and_Sponsors']"/></fo:block>
										</fo:table-cell>
									</fo:table-row>
								</xsl:if>
								...
								<xsl:if test="/ddi:codeBook/ddi:stdyDscr/ddi:citation/ddi:rspStmt/ddi:AuthEnty">
									<fo:table-row>
										<fo:table-cell font-weight="normal" border="{$default-border}" padding="{$cell-padding}">
											<fo:block><xsl:value-of select="$msg/*/entry[@key='Primary_Investigators']"/></fo:block>
										</fo:table-cell>
										<fo:table-cell border="{$default-border}" padding="{$cell-padding}">
											<fo:block>
								...
								<xsl:if test="/ddi:codeBook/ddi:stdyDscr/ddi:citation/ddi:prodStmt/ddi:producer">
									<fo:table-row>
										<fo:table-cell font-weight="normal" border="{$default-border}" padding="{$cell-padding}">
											<fo:block><xsl:value-of select="$msg/*/entry[@key='Other_Producers']"/></fo:block>
										</fo:table-cell>
										<fo:table-cell border="{$default-border}" padding="{$cell-padding}">
											<fo:block>
								...
								<xsl:if test="/ddi:codeBook/ddi:stdyDscr/ddi:citation/ddi:prodStmt/ddi:fundAg">
									<fo:table-row>
										<fo:table-cell font-weight="normal" border="{$default-border}" padding="{$cell-padding}">
											<fo:block><xsl:value-of select="$msg/*/entry[@key='Funding_Agencies']"/></fo:block>
										</fo:table-cell>
										<fo:table-cell border="{$default-border}" padding="{$cell-padding}">
											<fo:block>
								...
								<xsl:if test="/ddi:codeBook/ddi:stdyDscr/ddi:citation/ddi:rspStmt/ddi:othId">
									<fo:table-row>
										<fo:table-cell font-weight="normal" border="{$default-border}" padding="{$cell-padding}">
											<fo:block><xsl:value-of select="$msg/*/entry[@key='Other_Acknowledgments']"/></fo:block>
										</fo:table-cell>
										<fo:table-cell border="{$default-border}" padding="{$cell-padding}">
											<fo:block>
								...
								<xsl:if test="/ddi:codeBook/ddi:stdyDscr/ddi:method/ddi:notes[@subject='collection']">
									<fo:table-row>
										<fo:table-cell number-columns-spanned="2" border="{$default-border}" padding="{$cell-padding}">
											<fo:block font-weight="bold" text-decoration="underline"><xsl:value-of select="$msg/*/entry[@key='Data_Collection_Notes']"/></fo:block>
								...
								<xsl:if test="/ddi:codeBook/ddi:stdyDscr/ddi:method/ddi:notes[@subject='processing']">
									<fo:table-row>
										<fo:table-cell number-columns-spanned="2" border="{$default-border}" padding="{$cell-padding}">
											<fo:block font-weight="bold" text-decoration="underline"><xsl:value-of select="$msg/*/entry[@key='Data_Processing_Notes']"/></fo:block>
											<xsl:apply-templates select="/ddi:codeBook/ddi:stdyDscr/ddi:method/ddi:notes[@subject='collection']"/>
										</fo:table-cell>
									</fo:table-row>
								</xsl:if>
								...
								<xsl:if test="/ddi:codeBook/ddi:stdyDscr/ddi:method/ddi:notes[@subject='cleaning']">
									<fo:table-row>
										<fo:table-cell number-columns-spanned="2" border="{$default-border}" padding="{$cell-padding}">
											<fo:block font-weight="bold" text-decoration="underline"><xsl:value-of select="$msg/*/entry[@key='Data_Cleaning_Notes']"/></fo:block>
											<xsl:apply-templates select="/ddi:codeBook/ddi:stdyDscr/ddi:method/ddi:notes[@subject='collection']"/>
										</fo:table-cell>
									</fo:table-row>
								</xsl:if>
...
<!-- Look for variables in this group -->
	...
	<xsl:template match="ddi:var" mode="variables-list">
		...
		<fo:table-row text-align="center" vertical-align="top">
			...
			<!-- Variable Literal Question orig
	...
	<xsl:template name="header">
		...
		<fo:static-content flow-name="xsl-region-before">
			...
			<!-- <fo:block font-size="10">
				<xsl:value-of select="/ddi:codeBook/ddi:stdyDscr/ddi:citation/ddi:titlStmt/ddi:titl"/> - <xsl:value-of select="$section"/>
			</fo:block>-->
		</fo:static-content>
	</xsl:template>
