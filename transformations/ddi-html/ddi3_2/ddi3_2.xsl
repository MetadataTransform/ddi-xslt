<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:g="ddi:group:3_2" xmlns:d="ddi:datacollection:3_2" xmlns:dce="ddi:dcelements:3_2" xmlns:c="ddi:conceptualcomponent:3_2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:a="ddi:archive:3_2"
    xmlns:m1="ddi:physicaldataproduct/ncube/normal:3_2" xmlns:ddi="ddi:instance:3_2" xmlns:m2="ddi:physicaldataproduct/ncube/tabular:3_2" xmlns:l="ddi:logicalproduct:3_2" xmlns:m3="ddi:physicaldataproduct/ncube/inline:3_2" xmlns:pd="ddi:physicaldataproduct:3_2"
    xmlns:cm="ddi:comparative:3_2" xmlns:s="ddi:studyunit:3_2" xmlns:r="ddi:reusable:3_2" xmlns:pi="ddi:physicalinstance:3_2" xmlns:ds="ddi:dataset:3_2" xmlns:pr="ddi:profile:3_2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xmlns:util="https://code.google.com/p/ddixslt/#util" version="2.0" xsi:schemaLocation="ddi:instance:3_2 http://www.ddialliance.org/Specification/DDI-Lifecycle/3.2/XMLSchema/instance.xsd">
